...
# from PyQt5.QtGui import QColor, QColorConstants, QPalette, QShortcut
from PyQt5.QtGui import QColor, QColorConstants, QPalette
...
class DisplaySettingsWindow(QtWidgets.QWidget):
    ...
    def changeReturnLoss(self):
        # print("Test Device: Pre-Serial Connection Readings")
        # print("DisplaySettings, changeReturnLoss()")
