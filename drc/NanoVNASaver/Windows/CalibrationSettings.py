...
class CalibrationWindow(QtWidgets.QWidget):
    ...
    def __init__(self, app: QtWidgets.QWidget):
        ...
        QtWidgets.QShortcut(QtCore.Qt.Key.Key_Escape, self, self.hide)
    ...
    def calculateforTestDevice(self):
        ...
        try:
            ...
            if logger.isEnabledFor(logging.DEBUG):
                raise ("Error applying calibration")

    def loadCalibrationforTestDevice(self):
        filename = "True_Calibration.cal"
        print("Calibration File: True_Calibration.cal")
        ...
        print("Pre-calibration Loss Readings: ")
        self.calculateforTestDevice()
        ...
        print("Sweeping in calibration")
        frequencies[0] = 2300000000 #2.3 GHz
        frequencies[-1] = 2500000000 #2.5 GHz
        print("Start frequency: " + str(frequencies[0]) + " and stop frequency: " + str(frequencies[-1]))
    ...
    def loadCalibration(self):
        ...
        print("New calibration data applied. Performing sweep... ")
    ...
    def automaticCalibrationStep(self):
        ...
        if self.nextStep == 4:
            ...
            # Caroline - perhaps use cal_save to save sweeps
            # Done
