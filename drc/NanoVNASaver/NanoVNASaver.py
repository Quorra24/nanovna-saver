...
class NanoVNASaver(QWidget):
    ...
    def __init__(self):
        ...
        self.calibration = Calibration() #from Calibration.py
    ...
    def establishSerial(self):
        self.serial_control.connect_device()
        print("Status: Serial connection established")

    def performCalibration(self):
        self.cal.loadCalibrationforTestDevice()
        self.performSweep()
        print("Status: Calibration parameters loaded")
    ...
    def markerUpdated(self, marker: Marker):
        # Does not run in Test Device mode
        with self.dataLock:
    ...
    def dataUpdated(self):
        # Test Device: Called every time sweep happens
        with self.dataLock:
            s11 = self.data.s11[:]
            s21 = self.data.s21[:]
